class PostsController < ApplicationController
  ...
  def destroy
    @post.destroy
    respond_to do |format|
      format.html { redirect_to bulletin_post_url, notice: 'Post was successfully destroyed.' }
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :content, :picture, :picture_cache, :user_id)
    end
end
